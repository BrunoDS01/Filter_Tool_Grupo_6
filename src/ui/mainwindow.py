...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout_24.addWidget(self.cambiarRangoFiltroButton, 11, 0, 2, 1)
        ...
        self.gridLayout_24.addWidget(self.cambiarOrdenFiltroButton, 10, 0, 1, 1)
        self.label_2 = QtWidgets.QLabel(self.groupBox)
        self.label_2.setObjectName("label_2")
        self.gridLayout_24.addWidget(self.label_2, 6, 0, 1, 1)
        ...
        self.gridLayout_24.addWidget(self.rangoLP, 11, 1, 1, 1)
        ...
        self.gridLayout_24.addWidget(self.ordenLP, 10, 1, 1, 1)
        ...
        self.gridLayout_24.addWidget(self.graficarFiltrosButton, 8, 0, 2, 2)
        ...
        self.minFreq = QtWidgets.QPlainTextEdit(self.groupBox)
        self.minFreq.setMaximumSize(QtCore.QSize(16777215, 20))
        self.minFreq.setObjectName("minFreq")
        self.gridLayout_24.addWidget(self.minFreq, 7, 0, 1, 1)
        self.maxFreq = QtWidgets.QPlainTextEdit(self.groupBox)
        self.maxFreq.setMaximumSize(QtCore.QSize(16777215, 20))
        self.maxFreq.setObjectName("maxFreq")
        self.gridLayout_24.addWidget(self.maxFreq, 7, 1, 1, 1)
        ...
        self.etapaGanMagPlotBox = QtWidgets.QGroupBox(self.tab_6)
        ...
        self.gridLayout_26.addWidget(self.etapaGanMagPlotBox, 0, 1, 1, 1)
        self.etapaGanFasPlot = QtWidgets.QGroupBox(self.tab_6)
        self.etapaGanFasPlot.setTitle("")
        self.etapaGanFasPlot.setObjectName("etapaGanFasPlot")
        self.gridLayout_31 = QtWidgets.QGridLayout(self.etapaGanFasPlot)
        self.gridLayout_31.setObjectName("gridLayout_31")
        self.gridLayout_26.addWidget(self.etapaGanFasPlot, 1, 1, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.graficarRespEtapaButton.setText(_translate("MainWindow", "Graficar respuesta en frecuencia"))
